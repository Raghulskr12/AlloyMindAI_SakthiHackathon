...
def load_models():
    ...
    model_files = {
        'EN1563': 'element_config_ensemble_model.pkl',
    ...
    info_files = {
        'EN1563': 'element_config_training_info.json',
...
def get_target_specifications(grade: str) -> Dict[str, float]:
    ...
    grade_specs = {
        'EN1563': {'C': 3.6, 'Si': 2.4, 'Mn': 0.25, 'P': 0.025, 'S': 0.005, 'Cu': 0.225, 'Mg': 0.0475},
...
def create_input_dataframe(grade: str, composition: CompositionInput, furnace_id: str) -> pd.DataFrame:
    ...
    if grade == 'EN1563':
        model_key = 'EN1563'
    elif 'ASTMA536_UPDATED' in grade:
    ...
    if model_key in models:
        ...
        if 'Furnace_ID' in label_encoders:
            ...
            # For EN1563, use the same encoding as CLI
