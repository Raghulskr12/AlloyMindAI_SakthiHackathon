...
export default function AlloySpecificationPage() {
  const [selectedGrade, setSelectedGrade] = useState<(typeof alloyGrades)[0] | null>(null)
            ...
            <DialogContent className="bg-slate-800 border-slate-700">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={newGradeCategory} onValueChange={setNewGradeCategory}>
                    ...
                    <SelectContent className="bg-slate-800 border-slate-700">
                      <SelectItem value="carbon" className="text-white">
                        Carbon Steel
                      </SelectItem>
                      <SelectItem value="alloy" className="text-white">
                        Alloy Steel
                      </SelectItem>
                      <SelectItem value="stainless" className="text-white">
                        Stainless Steel
                      </SelectItem>
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <Button className="bg-blue-600 hover:bg-blue-700">Create Grade</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
