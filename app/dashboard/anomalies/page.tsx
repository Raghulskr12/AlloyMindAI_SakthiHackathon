...
const rootCauseStats = [
  { type: "Sensor", count: 12, percentage: 40 },
  { type: "Process", count: 9, percentage: 30 },
  { type: "AI", count: 6, percentage: 20 },
  { type: "Equipment", count: 3, percentage: 10 },
]
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <Select value={filterRootCause} onValueChange={setFilterRootCause}>
                    ...
                    <SelectContent className="bg-slate-800 border-slate-700">
                      <SelectItem value="Sensor" className="text-white">
                        Sensor
                      </SelectItem>
            ...
            <div className="space-y-4">
              {anomalies.map((anomaly) => (
                <Card key={anomaly.id} className="bg-slate-800/50 border-slate-700">
                  <CardHeader>
                    <div className="flex items-center justify-between">
          ...
          <div className="space-y-6">
            <Card className="bg-slate-800/50 border-slate-700">
              <CardHeader>
                ...
                <CardDescription className="text-slate-400">Last 30 days breakdown</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
